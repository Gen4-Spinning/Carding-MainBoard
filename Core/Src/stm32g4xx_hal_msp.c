...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, DAC1_OUT_Pin|DAC2_OUT_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, BT_USART1_TX_Pin|BT_USART1_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PB4     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOB, DBG_USART2_TX_Pin|DBG_USART2_RX_Pin);
